...
for ($n = 0; $n < 1024 * 1024; ++$n) {
    ...
    /*
     * Para diminuir a quantidade de diretórios criados, podemos aumentar a
     * densidade de entradas por diretório (de 256 para 4096 ítens por
     * diretório).
     */
     $densidade = 3;

    for ($p = 0; $p < (strlen($uuid) - $redutor); $p += $densidade) {
        $caminho .= "/" . substr($uuid, $p, $densidade);
